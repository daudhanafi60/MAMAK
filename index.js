const  XBOT = 'DAUD BOT'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/ghlyhalamn'; // Nama Instagramlu cok
const nomer = 'http://wa.me/+6281216795577'; // Nomor whatsapplu cok
...
conn.sendMessage(id, 'Owner XBOT http://wa.me/+6281216795577' ,MessageType.text);
}
else if (text == 'affis'){
